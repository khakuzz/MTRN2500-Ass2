...
namespace GamePad {
	...
	public:
		...
		GamePad::Coordinate LeftThumbLocation(); // Obtains the location of the thumb locations and then is filtered
		GamePad::Coordinate RightThumbLocation(); // through the dead zone and returns the new coordinates
	...
	private:
		...
		DWORD UserID; // Stores the value of the controller so it can be identified
		XINPUT_STATE State;
		XINPUT_VIBRATION Vibration;
		unsigned int Deadzone; // Stores the dead zone input which is used later
